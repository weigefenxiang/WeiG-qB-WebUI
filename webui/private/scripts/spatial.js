(function(global){
  ...
  var defs=[
    ...
    {kind:'savePath',title:function(){return label('Path','路径');},className:'facet-select--path',aria:function(){return label('Path filter','路径筛选');},set:function(v){return W.LibraryController&&W.LibraryController.setSavePath(v);}}
  ];
