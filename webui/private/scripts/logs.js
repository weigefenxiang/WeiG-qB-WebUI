(function(global){
  ...
  var state={items:[],lastId:-1,types:new Set([1,2,4,8]),query:'',follow:true,viewport:null,timer:null,loading:false,active:false,root:null,sizeMode:localStorage.getItem((W.StorageKeys&&W.StorageKeys.logsSizeMode)||'weig.logs.sizeMode')||'auto',programmaticScroll:false,expandedId:null};
  var MAX_ITEMS=5000;
