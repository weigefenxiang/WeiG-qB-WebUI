(function(global){
  ...
  var VERSION='0.3.7',cssObserver=null,ordering=false;
  ...
  function start(){
    ...
    load('scripts/i18n-v037.js','i18n-037')
      ...
      .then(function(){
        var init=function(){ensureCssOrder();if(W.V037Settings)W.V037Settings.init();if(W.V037Selection)W.V037Selection.init();if(W.V037Layout)W.V037Layout.init();if(W.V037UiSystem)W.V037UiSystem.init();W.V037={version:VERSION,settings:W.V037Settings,selection:W.V037Selection,layout:W.V037Layout,ui:W.V037UiSystem};global.dispatchEvent(new CustomEvent('weigg:v037ready'));};
