(function(global){
  ...
  function css(){if(document.querySelector('link[data-weigg-layer="v037"]'))return;var l=document.createElement('link');l.rel='stylesheet';l.dataset.weiggLayer='v037';l.href=url('css/v037.css');document.head.appendChild(l);}
  ...
  function start(){
    ...
    load('scripts/i18n-v037.js','i18n-037')
      ...
      .then(function(){
        var init=function(){if(W.V037Settings)W.V037Settings.init();if(W.V037Selection)W.V037Selection.init();if(W.V037Layout)W.V037Layout.init();W.V037={version:VERSION,settings:W.V037Settings,selection:W.V037Selection,layout:W.V037Layout};global.dispatchEvent(new CustomEvent('weigg:v037ready'));};
