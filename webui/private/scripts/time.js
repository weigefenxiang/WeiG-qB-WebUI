(function(global){
  ...
  var KEY=(W.StorageKeys&&W.StorageKeys.displayTimeZone)||'weig.displayTimeZone';
  ...
  function setZone(zone){zone=zone||'system';try{localStorage.setItem(KEY,zone);}catch(_e){}global.dispatchEvent(new CustomEvent('weig:timezonechange',{detail:{zone:zone}}));return zone;}
