(function(global){
  ...
  Client.prototype.logs=function(lastId){var q='normal=true&info=true&warning=true&critical=true&last_known_id='+(lastId==null?-1:lastId);return this.request('log/main?'+q);};
  Client.prototype.peerLogs=function(lastId){return this.request('log/peers?last_known_id='+(lastId==null?-1:lastId));};
