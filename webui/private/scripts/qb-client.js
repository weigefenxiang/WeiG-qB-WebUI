(function(global){
  ...
  Client.prototype.editTracker=function(hash,origUrl,newUrl){return this.request('torrents/editTracker',{method:'POST',form:{hash:hash,origUrl:origUrl,newUrl:newUrl},type:'void'});};
