(function(global){
  ...
  var EN={
    ...
    'v036.mobile.count':'{count} Torrents',
    'v036.mobile.focus.expand':'Expand list',
    'v036.mobile.focus.collapse':'Restore layout',
    'v036.facet.tracker':'Tracker',
    'v036.facet.path':'Path',
    'v036.facet.category':'Category',
    'v036.facet.tag':'Tag'
  };
  var ZH={
    'v036.logs.normal':'普通',
    ...
    'v036.mobile.count':'共 {count} 个 Torrent',
    'v036.mobile.focus.expand':'展开列表',
    'v036.mobile.focus.collapse':'收起列表',
    'v036.facet.tracker':'Tracker',
    'v036.facet.path':'路径',
    'v036.facet.category':'分类',
    'v036.facet.tag':'标签'
  };
