...
export async function summarizeProductProfile(profile,catalog,shared=null){
  const rt=shared||createCompactRuntime(catalog,{owners:PRODUCT_OWNERS}),C=rt.W.CapabilityRegistry,T=rt.W.TorrentSemantics,F=rt.W.TorrentFieldRegistry;
