...
const index=read('webui/private/index.html'),session=read('webui/private/scripts/session.js'),settings=read('webui/private/scripts/settings.js'),rss=read('webui/private/scripts/rss.js'),core=read('webui/private/scripts/core.js'),app=read('webui/private/scripts/app.js'),ui=read('webui/private/scripts/ui.js'),layout=read('webui/private/scripts/layout.js'),dialogs=read('webui/private/scripts/dialog-runtime.js'),actions=read('webui/private/scripts/action-registry.js'),columns=read('webui/private/scripts/column-configurator.js'),floating=read('webui/private/scripts/floating.js'),theme=read('webui/private/css/theme.css'),tableCss=read('webui/private/css/table.css'),i18n=read('webui/private/scripts/i18n.js');
