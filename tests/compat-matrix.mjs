...
console.log(`Compatibility policy passed: representative 4.1.9.1 + 5.2.0 generations; fixture release matrix retains ${matrix.releaseGate.length} nodes; full stable-tag coverage is owned by upstream-release-audit.mjs.`);
