...
try{
  ...
  assert(await page.locator('#column-configurator-dialog .shared-column-settings__row').filter({hasText:'Ratio'}).count()===0,'limited: Desktop Columns dialog exposed unavailable Ratio');
