...
assert.ok(!rss.includes('returnHash')&&!rss.includes('captureReturnHash')&&!rss.includes('restoreReturnHash')&&!rss.includes("Router.go('rss')"),'RSS Downloader must remain on the opener route and open as a route-independent canonical dialog.');
