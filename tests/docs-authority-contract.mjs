...
console.log(`Docs authority contract passed: ${required.length} canonical docs + DESIGN remain, ${retired.length} retired duplicate/version-history docs stay removed, per-VERSION retrospective/handoff files are blocked, and docs/014 is the single copyable current handoff owner.`);
