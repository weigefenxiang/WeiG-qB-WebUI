...
profile={qbVersion:'6.0.0',webApiVersion:'3.0.0',fallback:false,resolutionMode:'EXACT',apiActions:ALL,apiActionParameters:{[SET_DL]:{parameters:['limit'],required:['limit'],optional:[]},[SET_UL]:{parameters:['limit'],required:['limit'],optional:[]},[ADD]:{parameters:['urls','savepath','paused'],required:[],optional:['urls','savepath','paused']}}};
