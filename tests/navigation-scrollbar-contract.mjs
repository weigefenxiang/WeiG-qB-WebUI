...
assert(controls.includes('content-visibility:auto')&&controls.includes('contain-intrinsic-size:auto 22px'),'long Select option lists must skip off-screen rendering while keeping intrinsic content height aligned with the real ~38px outer option row so native scrollbar extent stays stable during thumb drag');
