...
console.log('Navigation/scrollbar contract passed: standalone Search nav retired, themed scrollbars remain canonical, and torrent header/rows share native horizontal scroll ownership without DataViewport rebuild repair.');
