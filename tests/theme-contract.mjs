...
const docs=[read('DESIGN.md'),read('ARCHITECTURE.md'),read('webui/ARCHITECTURE.md')].join('\n');
...
assert(index.includes('"scripts/theme.js"'),'Canonical theme owner is not loaded by the private bootstrap');
