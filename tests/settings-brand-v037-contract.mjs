...
for(const token of ['BRAND-SYSTEM-001','BRAND-IDENTITY-001','SETTINGS-DESIGN-001','W.Navigation.goHome','BrandMark','BrandCluster','BrandIdentity','ControlRegistry','settings-grid-canonical','settingSpan','settingsOwner','activeSettingsOwner','mergeExtraGrids'])assert(js.includes(token),`Settings/Brand canonical owner missing ${token}`);
